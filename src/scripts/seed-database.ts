...
const sampleCameras = [
  {
    ...
    stream_url: 'rtsp://192.168.68.105:554/stream1',
    is_online: true,
  ...
  },
  {
    ...
    stream_url: 'rtsp://192.168.68.102:554/stream1',
    is_online: true,
    recording_enabled: true,
    resolution: '1080p',
    type: 'indoor',
  ...
  },
  {
    ...
    type: 'indoor',
    onvif_enabled: true,
    onvif_host: '192.168.68.100',
    onvif_port: 80,
    onvif_username: '102537947',
    onvif_password: 'hv8UJPnJ',
  ...
  },
  {
    ...
    stream_url: 'rtsp://192.168.68.103:554/stream1',
    is_online: true,
    recording_enabled: false,
    resolution: '1080p',
    type: 'indoor',
    onvif_enabled: true,
    onvif_host: '192.168.68.103',
    onvif_port: 80,
    onvif_username: '102361681',
    onvif_password: 'hv8UJPnJ',
    onvif_profile_token: 'profile_3'
  }
];
